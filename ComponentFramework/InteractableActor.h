...
public: 
	...
	InteractableActor(Ref<AssetManager> assMan, Vec3 pos, float triggerRadius = 0.5f, Vec3 scale = Vec3(0.1f, 0.1f, 0.1f), std::shared_ptr<MaterialComponent> material = nullptr, std::shared_ptr<ShaderComponent> shader = nullptr);
